...
Crosswalk QA follows [text execution plan](https://crosswalk-project.org/#wiki/Crosswalk-testing-home) to perform weekly and daily tests on Android and Tizen platforms, most of the test results are archived in [crosswalk-dev](https://lists.crosswalk-project.org/pipermail/crosswalk-dev/) mailing list, in this page, QA summarized the test result indicators to present the overall test results of Crosswalk binaries.
